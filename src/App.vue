    ...
    <header class="header">
      <div>
        <section class="header-main">
          <router-link
            ...
            <img
              id="logo"
              src="./assets/logo.png">
            <span class="site-title">Cheetah Grid <span class="beta">Beta</span></span>
          </router-link>
        ...
        <section>
          ...
          <div class="menu-item">
            <a
              href="https://future-architect.github.io/cheetah-grid/">
              <span class="link">Cheetah Grid</span>
            </a>
          </div>
          <div class="menu-item">
            <a
              class="link"
              href="https://github.com/ota-meshi/cheetah-grid-beta-demo">
              <span> View on GitHub (Beta Demo) </span>
              <svg
                version="1.1"
                width="16"
                height="16"
